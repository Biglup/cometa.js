...
export const KEY_PAYMENT_CREDENTIAL: Cometa.Credential = {
  hash: PAYMENT_KEY_HASH,
  type: Cometa.CredentialType.KeyHash
};

export const KEY_STAKE_CREDENTIAL: Cometa.Credential = {
  hash: STAKE_KEY_HASH,
  type: Cometa.CredentialType.KeyHash
};

export const SCRIPT_CREDENTIAL: Cometa.Credential = {
  hash: SCRIPT_HASH,
