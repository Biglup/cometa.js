...
import { Credential } from '../../src/address/Credential';
import { CredentialType } from '../../src/address/CredentialType';
import { StakePointer } from '../../src/address/StakePointer';

export const KEY_PAYMENT_CREDENTIAL: Credential = {
  hash: '9493315cd92eb5d8c4304e67b7e16ae36d61d34502694657811a2c8e',
  type: CredentialType.KeyHash
};

export const KEY_STAKE_CREDENTIAL: Credential = {
  hash: '337b62cfff6403a06a3acbc34f8c46003c69fe79a3628cefa9c47251',
  type: CredentialType.KeyHash
};

export const SCRIPT_CREDENTIAL: Credential = {
  hash: 'c37b1b5dc0669f1d3c61a6fddb2e8fde96be87b881c60bce8e8d542f',
  type: CredentialType.ScriptHash
};

export const POINTER: StakePointer = {
  certIndex: 3,
  slot: 2_498_243n,
  txIndex: 27
};
